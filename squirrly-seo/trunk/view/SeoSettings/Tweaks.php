                                ...
                                <div id="robots" class="col-12 py-0 px-4 m-0 tab-panel">
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5">
                                        ...
                                        <div class="col-8 p-0 m-0 form-group">
                                            ...
                                            ?>
                                            <textarea class="form-control" name="robots_permission" rows="10"><?php echo esc_textarea( $robots_permission ) ?></textarea>
                                ...
                                <div id="llms" class="col-12 py-0 px-4 m-0 tab-panel">
                                    ...
                                    <div class="col-12 row m-0 p-0 my-5">
                                        ...
                                        <div class="col-8 p-0 m-0 form-group">
                                            ...
                                            ?>
                                            <textarea class="form-control" name="llms_permission" rows="10"><?php echo esc_textarea( $llms_permission ) ?></textarea>
