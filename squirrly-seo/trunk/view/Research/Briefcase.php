                                ...
                                <tr id="sq_row_<?php echo (int) $row->id ?>">
                                    ...
                                    <td style="width: 15%;white-space: nowrap;">
										<?php if ( isset( $row->research->sv->absolute ) ) {
											echo '<span data-value="' . (int) $row->research->sv->absolute . '">' . ( ( isset( $row->research->sv->absolute ) && is_numeric( $row->research->sv->absolute ) ) ? number_format( $row->research->sv->absolute ) : esc_html( $row->research->sv->absolute ) ) . '</span>';
										} else {
