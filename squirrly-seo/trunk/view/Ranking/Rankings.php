                                                                        ...
                                                                        <script>
                                                                            if (typeof google !== 'undefined') {
                                                                                google.setOnLoadCallback(function () {
                                                                                    drawChart("sq_chart", <?php echo wp_json_encode( $view->info->average, JSON_HEX_TAG | JSON_HEX_AMP )?> , true);
                                                                                });
                                                                            }
                                                                        </script>
                                        ...
                                        <tr>
											...
											<?php } else { ?>
                                                <td>
                                                    ...
                                                    <a href="<?php echo esc_url( $row->permalink ) ?>" target="_blank"><?php echo esc_html( $path <> '' ? urldecode( $path ) : urldecode( $row->permalink ) ) ?></a>
                                                </td>
												<?php if ( $view->checkin->subscription_serpcheck ) { ?>
								...
								<?php if ( isset( $view->max_num_pages ) && $view->max_num_pages ) { ?>
                                    <div class="row col-12 m-0 p-0 my-2">
                                        <div class="col alignleft mr-3">
                                            ...
                                            <span class="mx-3"><?php echo esc_html__( "Total", 'squirrly-seo' ); ?>: <?php echo (int) $view->total ?> <?php echo esc_html__( "records", 'squirrly-seo' ); ?></span>
                                        </div>
                                                ...
                                                <div class="modal-body pt-0" style="min-height: 90px;">
                                                    <ul class="col-12">
                                                        <li class="row py-2 border-bottom">
                                                            <div class="col-12">
                                                                <strong><a href="<?php echo esc_url( $row->permalink ) ?>" target="_blank"><?php echo esc_html( urldecode( $row->permalink ) ) ?></a></strong>
                                                            </div>
                                                        </li>
														...
														<?php if ( isset( $row->datetime ) ) { ?>
                                                            <li class="row py-2 border-bottom-0">
                                                                ...
                                                                <div class="col-6">
                                                                    <strong><?php echo esc_html( wp_date( get_option( 'date_format' ), strtotime( $row->datetime ) ) ) ?></strong>
                                                                </div>
                                                            </li>
														<?php } ?>
