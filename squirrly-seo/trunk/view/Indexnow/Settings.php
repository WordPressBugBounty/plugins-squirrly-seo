        ...
        <div class="d-flex flex-row flex-nowrap flex-grow-1 bg-light m-0 p-0">
            <div class="flex-grow-1 sq_flex m-0 p-0 px-4 pb-4">
                ...
                <h3 class="mt-4 card-title">
					<?php echo esc_html__( "LLM Indexing Settings", 'squirrly-seo' ); ?>
                                        ...
                                        <div class="col-12 row p-0 m-0 my-3">
                                            <div class="col-4 p-0 font-weight-bold">
                                                <label for="indexnow_post_type"><?php echo esc_html__( "Automatically Submit Post Types", 'squirrly-seo' ); ?>
                                                    :</label>
                                                <div class="small text-black-50 my-1"><?php echo esc_html__( "Select post types you want to send for LLM Indexing.", 'squirrly-seo' ); ?></div>
                                            </div>
                                                ...
                                                <select id="indexnow_endpoints" multiple name="indexnow_endpoints[]" class="selectpicker form-control bg-input mb-1" data-live-search="true">
                                                    ...
                                                    if ( ! empty( $endpoints ) ) {
                                                        foreach ( $endpoints as $endpoint ) {
                                                            echo '<option value="' . esc_attr( $endpoint ) . '" ' . ( in_array( $endpoint, $dbendpoints ) ? 'selected="selected"' : '' ) . '>' . esc_html( parse_url( $endpoint, PHP_URL_HOST ) ) . '</option>';
                                                        }
                                                    }
                                                    ?>
                                                </select>
