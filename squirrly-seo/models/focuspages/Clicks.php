...
class SQ_Models_Focuspages_Clicks extends SQ_Models_Abstract_Assistant {
	...
	public function getHeader() {
		...
		if ( ! $this->_audit->sq_analytics_gsc_connected ) {
			...
			$header .= '<a href="' . SQ_Classes_Helpers_Tools::getAdminUrl( 'sq_research', 'research', array( 'keyword=' . esc_attr( $this->_keyword ) ) ) . '" target="_blank" class="btn btn-primary text-white col-12 mt-3">' . esc_html__( "Do a research", 'squirrly-seo' ) . '</a>';
		} else {
